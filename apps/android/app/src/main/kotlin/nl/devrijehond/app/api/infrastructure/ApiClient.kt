package nl.devrijehond.app.api.infrastructure

import nl.devrijehond.app.api.auth.HttpBearerAuth
...
import nl.devrijehond.app.api.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "nl.devrijehond.app.api.baseUrl"
        @Deprecated(
